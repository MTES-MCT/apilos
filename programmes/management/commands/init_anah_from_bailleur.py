...
class Command(BaseCommand):
    help = 'Met à jour le champ anah à True pour tous les programmes associés aux bailleurs dont le nom commence par "ANAH"'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS('Successfully updated all programmes from ANAH bailleurs.'))