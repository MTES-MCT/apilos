...
class Migration(migrations.Migration):
    ...
    dependencies = [
        (
            "conventions",
            "0037_avenanttype_remove_convention_avenant_type_and_more_squashed_0041_alter_convention_avenant_types",
        ),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("7. Dénoncée", "Convention dénoncée"),
                    ("8. Annulée en suivi", "Convention annulée en suivi"),
                ],
                default="1. Projet",
                max_length=25,
            ),
