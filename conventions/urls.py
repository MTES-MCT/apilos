...
from . import views
from .views import ConventionExportListView, ConventionSearchView, LoyerSimulateurView
...
urlpatterns = [
    ...
    path(
        "export-list",
        ConventionExportListView.as_view(),
        name="export_list",
    ),
    path(
        "simulateur-de-loyer",
    ...
    path(
        "avenant_cadastre/<convention_uuid>",
        views.AvenantCadastreView.as_view(),
        name="avenant_cadastre",
    ),
    path(
