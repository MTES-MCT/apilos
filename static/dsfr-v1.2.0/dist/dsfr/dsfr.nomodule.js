...
(function () {
  ...
  var Inspector = function Inspector () {
    ...
    var loop = function ( id ) {
      ...
      this$1[id] = function () {
        ...
        if (this$1.level <= level.level) { level.log.apply(level, msgs); }
      };
      this$1[id].print = level.print.bind(level);
    };
    ...
    Stage.prototype.mutate = function mutate (mutations) {
      ...
      mutations.forEach(function (mutation) {
        switch (mutation.type) {
          case 'childList':
            mutation.removedNodes.forEach(function (node) { return this$1.dispose(node); });
            mutation.addedNodes.forEach(function (node) { return this$1.parse(node); });
            break;

          case 'attributes':
            if (this$1.hasElement(mutation.target)) {
              var element = this$1.getElement(mutation.target);
            ...
            if (this$1.modifications.indexOf(mutation.target) === -1) { this$1.modifications.push(mutation.target); }
            break;
        }
      });
  ...
  Instance.prototype.unlistenKey = function unlistenKey (code, closure) {
    ...
    this._keyListenerTypes.forEach(function (type) {
      if (!this$1._keys.some(function (key) { return key.type === type; })) { this$1.unlisten(("key" + type), this$1.handlingKey); }
    });
  };
  ...
  var Collapse = /*@__PURE__*/(function (Disclosure) {
    ...
    Collapse.prototype.disclose = function disclose (withhold) {
      ...
      this.unbound();
      this.adjust();
      this.request(function () { Disclosure.prototype.disclose.call(this$1, withhold); });
    };
    ...
    Collapse.prototype.conceal = function conceal (withhold, preventFocus) {
      ...
      if (!this.disclosed) { return; }
      this.adjust();
      this.request(function () { Disclosure.prototype.conceal.call(this$1, withhold, preventFocus); });
    };
      ...
      if (this.img) {
        ...
        fetch(this.imgURL)
          ...
          .then(function (response) {
            ...
            this$1.svg = xmlDoc.querySelector('svg');
